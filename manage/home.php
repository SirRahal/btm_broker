...
{
alert("Please enter a value for the \"RTM Part Number\" field.");
...
<div align="center"><a href="index.php?ac=upload_pic1">Upload RTM Pic</a></div><br />
<div align="center"><a href="index.php?ac=upload_pic2">Upload NON RTM Pic</a></div><br />
...
<div align="center"><a href="http://www.reliabletoolmachine.com/search/admin/admin.php">Re-Index Site</a></div>
<br />
<form action="index.php?ac=edit_item"  method="POST" onsubmit="return Validate(this)">
<div align="center"><sup>FIND BY RTM PART NUMBER:</sup><br />  <input type="text" name="rtm_pn" size="15" maxlength="10"><br /><br />
